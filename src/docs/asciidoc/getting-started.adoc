...
The Java binary is available on https://github.com/rabbitmq/rabbitmq-stream-perf-test/releases[GitHub Release].
https://github.com/rabbitmq/rabbitmq-java-tools-binaries-dev/releases[Snapshots] are available as well. To use the latest snapshot:
