...
Have a look at the https://rabbitmq.github.io/rabbitmq-stream-java-client/stable/htmlsingle/#understanding-connection-logic[connection logic section] of the stream Java client in case of connection problem.
...
slightly higher, as the body is wrapped in an https://rabbitmq.github.io/rabbitmq-stream-java-client/stable/htmlsingle/#working-with-complex-messages[AMQP 1.0 message].
